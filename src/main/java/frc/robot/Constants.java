...
public final class Constants {
  public static class OperatorConstants {
    ...
    public static final int kJoystickRotationAxis = 4;

    public static final int goFwdTrigger = 3;
    public static final int goBckwdTrigger = 2;
    public static final int goRightButton = 2;
    public static final int goLeftPov = 270;
  }
